...
export function EmptyState({
  ...
  return (
    <div className="bg-background grid min-h-32 place-items-center gap-1 rounded-lg border border-dashed p-6 text-center">
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1">
        ...
        {result.diagnostic ? (
          <code className="text-xs">{result.diagnostic}</code>
        ) : null}
      </div>
    </div>
  )
...
export function Metric({
  ...
  return (
    <div className="bg-background grid min-h-28 content-start gap-2 rounded-lg border p-4">
...
export function Capability({
  ...
  return (
    <div className="bg-background grid min-h-36 content-start gap-2 rounded-lg border p-4">
      <span className="text-primary">{icon}</span>
      <strong>{title}</strong>
